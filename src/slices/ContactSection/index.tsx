        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-50 p-8 rounded-xl shadow-md">
             ...
             <form className="space-y-4 flex flex-col">
               <input type="text" placeholder="Seu Nome" className="p-3 border rounded-lg w-full" />
               <input type="email" placeholder="Seu E-mail" className="p-3 border rounded-lg w-full" />
               <textarea placeholder="Sua Mensagem..." rows={4} className="p-3 border rounded-lg w-full"></textarea>
               <button type="button" className="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition">
                 Enviar
               </button>
             </form>
          </div>
